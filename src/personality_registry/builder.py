    ...
    return {
        ...
        "product_layers": {
            ...
            "analysis_and_actualization": {
                ...
                "host_profile_count": len(extensions.host_profiles),
                "capability_count": len(extensions.capabilities),
                "artifact_class_count": len(extensions.artifact_classes),
                "actualization_protocol_count": len(extensions.actualization_protocols),
                "workflow_recipe_count": len(extensions.workflow_recipes),
            },
            "house_synthesis": {
        ...
        "agent_meta_skill": {
            ...
            "host": "codex",
            "repo_path": "skills/a-person-index-meta/",
            "path_hint": "$CODEX_HOME/skills/a-person-index-meta",
            "purpose": "Inspect the host environment abstractly, map available tools into capability records, classify the run, and choose the next A Person Index path before deeper work begins.",
            "recommended_for": [
                "capability discovery",
                "run classification",
                "actualization path selection",
                "host-aware planning",
            ],
        },
        "canonical_sources": {
        ...
        "governance": {
            ...
            "comparison_shapes_doc": "docs/comparison_shapes.md",
            "comparison_preflight_doc": "docs/comparison_preflight.md",
            "host_profiles_doc": "docs/host_profiles.md",
            ...
            "result_shape_discovery_doc": "docs/result_shape_discovery.md",
        ...
        "service_primitives": [
            ...
            {
                "id": "fetch_framework_result_shape",
                "command": "python3 scripts/query_registry.py result-shape \"Big Five\"",
                "purpose": "Return the construct-level result shape, scoring types, motif trace, and starter atom slots for a framework.",
            },
            {
        ...
        "interfaces": {
            ...
            "automation": {
                ...
                "lister": "scripts/list_codex_queue_tasks.py",
                "dispatch_workflow": ".github/workflows/dispatch-codex-queue-item.yml",
                "batch_dispatch_workflow": ".github/workflows/dispatch-ready-codex-queue.yml",
